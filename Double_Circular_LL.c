...
dcll_node *head, *tail, *prev_node, *next_node, *current_node, *temp, *new_node;

struct node *create_DCLL(int no_of_elements)
{
    dcll_node data_user;
    int i = 0;
    if ((head == NULL))
    {
        ...
        while (i < no_of_elements)
        {
            ...
            if (head == NULL)
            {
                ...
                current_node = (dcll_node *)malloc(sizeof(dcll_node));
            ...
            else
            {
                ...
                new_node = (dcll_node *)malloc(sizeof(dcll_node));
                ...
                new_node->next = head; // Circulation Here
                head->prev = new_node;
                tail = new_node; // End Of List With Tail To differ between begining and end ^^
                // printf("%d %d %d %d\n",new_node->next,head,head->prev,new_node); // Testing
            }
        }
        if (i == no_of_elements)
        {
...
void display_dcll() // Display All Elements of The list
{
    int i = 0;
    current_node = head;
...
int insert_node() // Insert any node at any specific required position
{
    ...
    else
    {
        if (pos == (list_length + 1)) // Last Position Entry
        {
            ...
            // printf("Head %d\n", head);
            // printf("%d %d %d %d\n",new_node->prev,new_node->next,head,tail->prev);
            // End of Testing
        ...
        else if (pos == 1)
        {
            ...
            // printf("Head %d\n", head);
            // printf("Affrimation Head %d\n", tail->next);
            // printf("%d %d Tail %d %d %d Head %d %d\n",current_node->next,next_node,current_node->prev,tail,head->prev,head,tail->next);
            // End of Testing
        ...
        else
        {
            ...
            */
            ...
            // Testing
            //  printf("%d %d %d %d\n",prev_node,new_node->prev,next_node->prev,new_node);
            // End of Testing
...
int entry_number_of_elements()
{
    ...
    printf("-------------------------------------------\n");
    current_node = create_DCLL(no_of_elements);
    // while (i < no_of_elements)
    // {
    //     printf("Enter Data of The Node!\n");
    //     scanf("%d", &user_data);
